"""
====================================================================
Plot the decision surfaces of ensembles of trees on alignment datasets
====================================================================
...
plot_step_coarser = 0.8  # step widths for coarse classifier guesses
RANDOM_SEED = 13  # fix the seed on each iteration

# Load data
csv_list = csv_iterator('./data/CSV/PRST-cumW7.csv')
csv_list = trim_data_by_top_segments(csv_list, 1)
...
models = [DecisionTreeClassifier(max_depth=None),
          ...
          AdaBoostClassifier(DecisionTreeClassifier(max_depth=7),
...
plt.suptitle("Classifiers on feature subsets of the composite alignment dataset", fontsize=12)
plt.axis("tight")
plt.tight_layout(h_pad=0.2, w_pad=0.2, pad=2.5)
plt.savefig("./prstCumW7Test.png", dpi=600)
